...
PLAYER_GOAL_MESSAGE = "As a player, you will present your business/startup ideas and compete with ideas generated by\n" \
                      ...
                      "environment etc. If you play the quiz, your goal is to collect as many points as possible!\n" \
                      ""

GAME_RULES_MESSAGE = "The game consists of 3 modes:\n" \
                     "\t1. CV mode\n" \
                     ...
                     "\t3. Quiz mode\n" \
                     "\t\tTest your knowledge about machine learning architectures and their application. Collect as\n" \
